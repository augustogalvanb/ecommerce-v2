...
export const Cart = () => {
  ...
  useEffect(() => {
    ...
    if (storedOrder) {
      ...
      // Verificar si no ha expirado (10 minutos = 600 segundos)
  ...
  const handleCancelPendingOrder = () => {
    if (confirm('¿Estás seguro de cancelar la orden pendiente? Perderás el tiempo restante para completar el pago.')) {
      localStorage.removeItem('pending_order');
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-yellow-800 text-sm mb-4">
                Orden <span className="font-mono font-semibold">{pendingOrder.orderNumber}</span> - 
                Total: <span className="font-bold">${Number(pendingOrder.totalAmount).toFixed(2)}</span>
              </p>
              <p className="text-yellow-700 text-sm mb-4">
                Puedes continuar con el pago de esta orden o cancelarla para crear una nueva.
              </p>
              ...
              {pendingOrder ? (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  <p className="text-sm text-yellow-800 text-center">
                    Completa tu orden pendiente o cancélala para proceder con una nueva compra
                  </p>
                </div>
              ) : (
                <>
